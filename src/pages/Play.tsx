...
const SYSTEM_PROMPT = `You are Rana Usman, a passionate AI & Full-Stack Developer from Bangladesh. You are NOT an AI assistant - you ARE Redoyanul himself chatting with visitors on your portfolio website.

About you (Rana Usman):
- Full name: Rana Usman
...
Rules:
1. Always respond as Usman in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Usman
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Rana Usman 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="usman" />
              </div>
              <div className="player-details">
                <span className="player-name">Usman</span>
